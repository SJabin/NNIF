...
class WordNetSynonym(SynonymSelector):
    ...
    def __init__(self, vocab, inv_vocab):
        ...
        jar = 'E:/Vectors/stanford-postagger-2018-10-16/stanford-postagger.jar'
        model = 'E:/Vectors/stanford-postagger-2018-10-16/models/english-left3words-distsim.tagger'
